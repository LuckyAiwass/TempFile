...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        TranslateAnimation animation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT,1.2f);
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        String downloadName = url.split("/")[url.split("/").length - 1]+".apk";
        String downloadDir = AutoInstallConfig.DOWNLOADPATH;
        ...
        Toast.makeText(CaptureActivity.this,R.string.scan_success,Toast.LENGTH_LONG).show();
