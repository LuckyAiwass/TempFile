...
public class OpenCameraInterface {
	...
	private static final String TAG = "YSTYST";
	...
	public static Camera open(int cameraId) {
		...
		if (cameraId < numCameras) {
			...
			//Log.i(TAG, "preview-flip :" + parameters.get("preview-flip"));
			...
			int degree =0;
			Log.i("YSTYST", "rotation: " + rotation);
			Log.i("YSTYST", "info.orientation: " + info.orientation);
			Log.i("YSTYST", "degree: " + degree);
			...
			camera.setDisplayOrientation(iRet);
		} else {
			if (explicitRequest) {
