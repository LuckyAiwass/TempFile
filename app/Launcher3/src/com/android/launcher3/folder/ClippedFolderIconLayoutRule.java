...
public class ClippedFolderIconLayoutRule {
    ...
    // urovo weiyu add on 2020-08-25 for urovo UI [s]
    private static final float MARGIN = 2; // the margin between the icon and the edge of folder
    // urovo weiyu add on 2020-08-25 for urovo UI [e]
    ...
    public PreviewItemDrawingParams computePreviewItemDrawingParams(int index, int curNumItems,
        ...
        float totalScale = MIN_SCALE * mBaselineIconScale;
        // urovo weiyu add on 2020-08-25 for urovo UI [e]
        float transX;
        float transY;
        ...
        if (index == 0) {
            ...
            transX = mIconSize * MIN_SCALE - MARGIN;
            transY = MARGIN;
        } else if (index == 2) {
            transX = MARGIN;
            transY = mIconSize * MIN_SCALE - MARGIN;
        } else if (index == 3) {
            transX = mIconSize * MIN_SCALE - MARGIN;
            transY = mIconSize * MIN_SCALE - MARGIN;
        }
        android.util.Log.d("Felix","transX--->"+transX+" transY--->"+transY);
        // urovo weiyu add on 2020-08-25 for urovo UI [e]
