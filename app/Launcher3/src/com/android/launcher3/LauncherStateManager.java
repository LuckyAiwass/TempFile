...
public class LauncherStateManager {
	...
	if (mState == LauncherState.OVERVIEW) {
		mLauncher.isClearButtonVisible = true;
	} else {
		mLauncher.isClearButtonVisible = false;
	}
	mLauncher.setClearButton(mLauncher.mDeviceProfile.isVerticalBarLayout(), mLauncher.isClearButtonVisible, mLauncher.hasRunningTask);
