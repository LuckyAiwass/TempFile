...
public class EncodingHandler {
     ...
     * 创建一维二维码图片
     */
    public static Bitmap create(String contents,int width,int height,BarcodeFormat marcodeFormat)
    {
...
//          try {
//              content = new String(contents.getBytes("UTF-8"),"ISO-8859-1");
...
//          }
     ...
     * @return
     */
    public static Bitmap createQRImage(String context, final int width, final int height, int errorLevel) {
        try {
            // 判断URL合法性
            ...
            hints.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.forBits(errorLevel) );
