...
import com.android.dialer.calllogutils.PhoneAccountUtils;//yifusheng 20210816 add calllog show sim1 or sim2
...
public class CallLogAdapter extends GroupingListAdapter
  ...
  private boolean loadData(CallLogListItemViewHolder views, long rowId, PhoneCallDetails details) {
	...
	details.accountIcon = PhoneAccountUtils.getAccountIcon(activity, accountHandle);//yifusheng 20210816 add calllog show sim1 or sim2
...
//Jeff_weisy [s] added for calllog geocode updated  after locale change from callinfo  20190430 BugID=54116
     if(activity!=null)
    {
      String updatedgeocode=PhoneNumberHelper.getGeoDescription(activity, details.number.toString(), details.countryIso);
      if(updatedgeocode!=null)
      {
        details.geocode= updatedgeocode;
      }
    }
//Jeff_weisy [e] added for calllog geocode updated after locale change from callinfo  20190430 BugID=54116
    views.info = info;
