...
import android.graphics.drawable.Drawable;//yifusheng 20210816 add calllog show sim1 or sim2
...
public class PhoneCallDetailsHelper
  ...
  public void setPhoneCallDetails(PhoneCallDetailsViews views, PhoneCallDetails details) {
	...
	//yifusheng 20210816 add calllog show sim1 or sim2 s
		...
		// yifusheng 20210816 add calllog show sim1 or sim2 e

    // Set the account label if it exists.
    String accountLabel = callLogCache.getAccountLabel(details.accountHandle);
    /*wanghongjian add change string*/
      if (!TextUtils.isEmpty(accountLabel)) {
	   if("zh".equals(Locale.getDefault().getLanguage())){
	      if(accountLabel.equals("CMCC")){
	         accountLabel= resources.getString(R.string.china_mobile,details.viaNumber);
		  }else if(accountLabel.equals("China Unicom")){
			  accountLabel= resources.getString(R.string.china_Unicom,details.viaNumber);
		  }else if(accountLabel.equals("China Telecom")){
			  accountLabel= resources.getString(R.string.china_Telecom,details.viaNumber);
		  }
	   }else if("en".equals((Locale.getDefault().getLanguage()))){
		   if(accountLabel.equals("中国电信")){
		   	   accountLabel= resources.getString(R.string.china_Telecom,details.viaNumber);
		   }else if(accountLabel.equals("中国移动")){
			  accountLabel= resources.getString(R.string.china_mobile,details.viaNumber);
		   }else if(accountLabel.equals("中国联通")){
			  accountLabel= resources.getString(R.string.china_Unicom,details.viaNumber);
		   }
	   }
      }
