...
import android.widget.ImageView;//yifusheng 20210816 add calllog show sim1 or sim2
...
public final class PhoneCallDetailsViews {
  ...
  public final ImageView callAccountIcon;//wanghongjian add call card 1 or 2 icon
  ...
  private PhoneCallDetailsViews(
      ...
      ImageView callAccountIcon,//wanghongjian add call card 1 or 2 icon
	...
	this.callAccountIcon = callAccountIcon;//wanghongjian add call card 1 or 2 icon
  ...
  public static PhoneCallDetailsViews fromView(View view) {
    return new PhoneCallDetailsViews(
        ...
        (ImageView) view.findViewById(R.id.call_account_icon),//wanghongjian add call card 1 or 2 icon
  ...
  public static PhoneCallDetailsViews createForTest(Context context) {
    return new PhoneCallDetailsViews(
        ...
        new TextView(context),
        new View(context),
        new ImageView(context),//wanghongjian add call card 1 or 2 icon
        new TextView(context));
  }
}
