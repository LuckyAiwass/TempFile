...
// urovo lincong add on 2021-03-26 [s]
import android.provider.Settings;
// urovo lincong add on 2021-03-26 [e]
...
public class CallButtonPresenter
 ...
 /* @Override
  ...
  private void updateButtonsState(DialerCall call) {
	...
	//[S]wanghongjian 20190215 add for call record
    // urovo lincong add on 2021-03-26 [s]
    mAutoRecord = Boolean.parseBoolean(Settings.System.getString(context.getContentResolver(), "ENABLE_AUTORECORD"));
    // urovo lincong add on 2021-03-26 [e]

    // added by lincong 20210323 for call record
