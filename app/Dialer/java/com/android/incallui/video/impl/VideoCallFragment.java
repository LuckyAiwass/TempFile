...
import android.telecom.VideoProfile;  //Jeff_weisy 20190402 for video to voice add bugid:58949
...
public class VideoCallFragment extends Fragment
  ...
  //Jeff_weisy 20190402 for video to voice add bugid:58949
  private ImageButton switchvoicecallButton;
  //Jeff_weisy 20190402 for video to voice add bugid:58949
  ...
  public View onCreateView(
	...
	//Jeff_weisy [S]20190402 for video to voice add bugid:58949
	switchvoicecallButton= (ImageButton) view.findViewById(R.id.videocall_switch_voicecall);
	switchvoicecallButton.setOnClickListener(this);
	//Jeff_weisy [E]20190402 for video to voice add bugid:58949
  ...
  public void onClick(View v) {
	...
	else if (switchvoicecallButton == v) {
	  LogUtil.i("VideoCallFragment.onClick", "switchvoicecallButton clicked");
	  inCallButtonUiDelegate.changeToVideoClicked(VideoProfile.STATE_AUDIO_ONLY);
	  videoCallScreenDelegate.resetAutoFullscreenTimer();
	}
  //Jeff_weisy [E]20190402 for video to voice add bugid:58949
  }
  ...
  @Override
  public void setRecord(boolean on){} //wanghongjian 20190215 add for call record
