...
//Jeff_weisy [s] add 20190601 BugID=54306 
import android.content.BroadcastReceiver;
import android.content.IntentFilter;
//Jeff_weisy [e] add 20190601 BugID=54306 
...
public class StatusBarNotifier
  ...
  private final Context mContext;//Jeff_weisy [s] add 20190601 BugID=54306 
...
//Jeff_weisy [e] add 20190601 BugID=54306 
  ...
  private BroadcastReceiver mediaReceiver = new BroadcastReceiver() {
        @Override
         ...
         {
		LogUtil.i("StatusBarNotifier.mediaReceiver", "received media button");
		if("android.intent.action.onMediaButton".equals(intent.getAction()))
		{
...
//Jeff_weisy [s] add 20190601 BugID=54306 
      {
        ...
        mediafilter.addAction("android.intent.action.onMediaButton");
        mContext.registerReceiver(mediaReceiver, mediafilter);
      }
   //Jeff_weisy [e] add 20190601 BugID=54306 
      if (call.isVideoCall()) {
