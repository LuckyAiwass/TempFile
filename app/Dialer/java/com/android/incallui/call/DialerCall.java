...
public class DialerCall implements VideoTechListener, StateChangedListener, CapabilitiesListener {
  ...
  public void setDisconnectCause(DisconnectCause disconnectCause) {
	...
	//shaoweijie add toast for showing disconnect cause.20201222.s
	if(disconnectCause.getCode() == DisconnectCause.ERROR && !TextUtils.isEmpty(disconnectCause.getDescription())){
		LogUtil.i("DialerCall.setState","disconnectCause:" + disconnectCause.getReason());
		Toast.makeText(context, disconnectCause.getDescription(), Toast.LENGTH_LONG).show();
	}
	//shaoweijie add toast for showing disconnect cause.20201222.e
  }
