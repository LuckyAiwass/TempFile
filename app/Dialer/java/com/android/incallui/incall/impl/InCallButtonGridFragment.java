...
public class InCallButtonGridFragment extends Fragment {
  ...
  private static final int BUTTON_COUNT = 7;//yifusheng 20211103 change 6 to 7
  ...
  public View onCreateView(
	...
	buttons[6] = ((CheckableLabeledButton) view.findViewById(R.id.incall_seventh_button));//yifusheng 20211103 add 
