...
class ButtonChooserFactory {
  ...
  private static ButtonChooser newImsAndWiFiButtonChooser() {
	...
	//yifusheng 20211103 change for layout show question s 
   // mapping.put(
    //    InCallButtonIds.BUTTON_UPGRADE_TO_VIDEO, MappingInfo.builder(4).setSlotOrder(10).build());
    //yifusheng 20211103 change for layout show question e
    mapping.put(
        InCallButtonIds.BUTTON_UPGRADE_TO_VIDEO, MappingInfo.builder(6).setSlotOrder(0).build());
    mapping.put(
