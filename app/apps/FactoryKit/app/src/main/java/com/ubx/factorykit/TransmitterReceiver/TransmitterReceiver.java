...
public class TransmitterReceiver extends Activity {
    ...
    public void finish() {
        ...
        // urovo yuanwei 如果是扬声器模式则关闭 BEGIN 2019-03-13
        if(mAudioManager.isSpeakerphoneOn()){
            mAudioManager.setSpeakerphoneOn(false);
        }
        // urovo yuanwei 如果是扬声器模式则关闭 END   2019-03-13
        super.finish();
    }
 	@Override
    ...
    public void setAudio() {
        ...
        // urovo yuanwei SQ38 没有听筒，使用扬声器播放录音 BEGIN 2019-03-13
        if(Utilities.getBuildProject().equals("SQ38")) {
            mAudioManager.setSpeakerphoneOn(true);
        }
        // urovo yuanwei SQ38 没有听筒，使用扬声器播放录音 END   2019-03-13
        //mAudioManager.setMode(AudioManager.MODE_IN_CALL);
        // AudioSystem.setForceUse(AudioSystem.FOR_MEDIA,
