 ...
 */
package com.ubx.factorykit.GPS;
...
public class GPS extends Activity {
    ...
    protected void onPause() {
        Settings.Secure.putInt(mContext.getContentResolver(), Settings.Secure.LOCATION_MODE, location_mod);//设置原来模式
        stopGPS();
        super.onPause();
    }
    ...
    GpsStatus.Listener gpsStatusListener = new GpsStatus.Listener() {
        ...
        public void onGpsStatusChanged(int arg0) {
            ...
            case GpsStatus.GPS_EVENT_FIRST_FIX:
                toast("Locate sucess");
                pass();
                loge("GPS_EVENT_FIRST_FIX pass() locate sucess");
                break;
            case GpsStatus.GPS_EVENT_SATELLITE_STATUS:
                ...
                if (count >= MIN_SAT_NUM)
                    pass();
                    loge("GPS_EVENT_SATELLITE_STATUS pass() count = " + count);
                break;
            default:
                break;
            }
    ...
    protected void onResume() {
        location_mod = Settings.Secure.getInt(mContext.getContentResolver(), Settings.Secure.LOCATION_MODE, 1);
        Settings.Secure.putInt(mContext.getContentResolver(), Settings.Secure.LOCATION_MODE, 1);//设置GPS仅限设备模式
        startGPS();
        super.onResume();
    };
    ...
    void fail(Object msg) {
        ...
        Utilities.writeCurMessage(getApplicationContext(), TAG,"Failed");
        finish();
    }
    ...
    void pass() {
        ...
        setResult(RESULT_OK);
        Utilities.writeCurMessage(getApplicationContext(), TAG,"Pass");
        finish();
    }
