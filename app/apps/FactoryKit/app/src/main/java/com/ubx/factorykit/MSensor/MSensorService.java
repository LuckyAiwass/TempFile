 ...
 */
package com.ubx.factorykit.MSensor;
...
public class MSensorService extends Service {
    
    private final static String TAG = "MSensorService";
    private static boolean result = false;
    private static Context mContext = null;
    private static int index = -1;
    private static SensorManager MSensorManager = null;
    private static Sensor mMSensor = null;
    private static MSensorListener mMSensorListener;
    ...
    private void start() {
        ...
        if (WORKROUND) {
            ...
            if (!MSensorManager.registerListener(mMSensorListener, mMSensor, SENSOR_DELAY)) {
