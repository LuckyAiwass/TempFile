 ...
 */
package com.ubx.factorykit.TouchPanelEdge;
...
public class TouchPanelEdge extends Activity {
    ...
    @Override
    public void finish() {
        //if (FactoryKitPro.mHaveNavbar) mStatusBarManager.showNavigationBar();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //logd("getNavigationBarHeight: " + getNavigationBarHeight(this));
        mStatusBarManager = (StatusBarManager)getSystemService(STATUS_BAR_SERVICE);
        //if (FactoryKitPro.mHaveNavbar) mStatusBarManager.removeNavigationBar();
        init(this);
       ...
       if (FactoryKitPro.FULL_SCREEN_HAVE_NAVBAR){
            // SQ53 720*1440 1080*2160
            mHightPix = mHightPix + getNavigationBarHeight(this);
        }
        // It must be common divisor of width and hight
        mStep = getStep(mWidthPix, mHightPix);
        mStep = mStep%2==0?mStep:++mStep;
        mRadius = mStep / 2;
    ...
    class Panel extends View {
        ...
        public void onDraw(Canvas canvas) {
			...
			canvas.drawText("W: " + w, mWidthPix / 2 - 20, mHightPix / 2 - 10,
					mPaint);
			canvas.drawText("H: " + h, mWidthPix / 2 - 20, mHightPix / 2 + 10,
					mPaint);
