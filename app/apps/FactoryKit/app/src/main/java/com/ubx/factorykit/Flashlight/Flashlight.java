 ...
 */
package com.ubx.factorykit.Flashlight;

import static com.ubx.factorykit.Values.HasFlashlightFile;
...
public class Flashlight extends Activity {
    ...
    final byte[] ON = { '2', '5', '5' };
    final byte[] OFF = { '0' };
    private static String deviceNode = "/sys/class/leds/flash/brightness";
