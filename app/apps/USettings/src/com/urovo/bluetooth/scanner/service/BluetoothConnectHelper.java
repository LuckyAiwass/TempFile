...
public class BluetoothConnectHelper {
    // Debugging
    private static final String TAG = "BTSCANConnectHelper";
    ...
    //private static final UUID MY_UUID_SECURE = UUIDHelper.SERIAL_PORT_PROTOCOL_UUID;
    private static final UUID MY_UUID_INSECURE =
            UUID.fromString("8ce255c0-200a-11e0-ac64-0800200c9a66");
    private static final UUID MY_UUID_SECURE_SDK =
     ...
     */
    public BluetoothConnectHelper(Context context, Handler handler) {
     ...
     */
    public void write(boolean state,String patch) {
    ...
    private void connectionFailed() {
        ...
        BluetoothConnectHelper.this.start();
    }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    len=len+bytes;
                    Log.i("urovo","*************************************bytes:"+bytes  +"   asa:"+len);
                    //out.write(data);
                    ...
                    if(!preferences.getBoolean("BTexport", false) && preferences.getBoolean("BTRead", false)){  
                     if(buffer != null) {
                        int[] temp_value = new int[bytes];
                        for (int i = 0; i < bytes; i++) {
                            temp_value[i] = buffer[i] & 0xff;
                        }
...
public boolean  ReadFileToBT(String content ,boolean flag) {
        //modify bug 18911 by huyanglin 20220127 start
        ...
        try {  
            ...
            writer = new FileWriter(sdCardDir.getCanonicalPath() +"/Custom_BT/default_Settings_property.xml", flag);  
        ...
        //modify bug 18911 by huyanglin 20220127 end
        return  true;
    }
        ...
        public void write(boolean state,String patch) {
            try {
                ...
                if(state)
                    BluetoothTransfer.sendFile(mmOutStream,patch);
                else 
                    mmOutStream.write("Success".getBytes());
