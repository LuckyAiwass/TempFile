...
public class HttpsManager {
    static private HttpsManager mOkhttpManager=null;
    private InputStream mTrustrCertificate;
    static public HttpsManager getInstance()
    {
        if(mOkhttpManager==null)
        {
            mOkhttpManager=new HttpsManager();
        }
    ...
    public SSLContext getSSLContext(Context context) {
        if(getTrustrCertificates()!=null)
        {
            ...
            try {
                ...
                sslContext.init(null, new TrustManager[] { trustManager }, null);// // 客户端信任的服务器端证书
