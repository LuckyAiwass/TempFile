...
public class DevelopmentSettingsDashboardFragment extends RestrictedDashboardFragment
    ...
    // urovo weiyu add on 2020-11-05 [s]
    @Override
    public void onResume() {
        super.onResume();
        if(android.os.SystemProperties.getInt("persist.sys.allow.adb", 0) > 0) {
            findPreference("enable_adb").setEnabled(false);
        } else {
            findPreference("enable_adb").setEnabled(true);
        }
    }
    // urovo weiyu add on 2020-11-05 [e]
