...
// urovo weiyu add on 2020-09-03 [s]
import android.widget.Toast;
import android.content.BroadcastReceiver;
import android.os.BatteryManager;
import android.content.IntentFilter;
// urovo weiyu add on 2020-09-03 [e]
...
public class MasterClearConfirm extends InstrumentedFragment {
    ...
    private Button.OnClickListener mFinalClickListener = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            // urovo weiyu add on 2020-09-03 [s]
            if(mLevel < 20 || (mLevel < 20 && mBatteryStatus != BatteryManager.BATTERY_STATUS_CHARGING)){
                Toast.makeText(getActivity(), R.string.disallow_masterclear, Toast.LENGTH_LONG).show();
                return;
            }
            // urovo weiyu add on 2020-09-03 [e]
    ...
    // urovo weiyu add on 2020-06-30 start
    private void doMasterClear(View v) {
        if(v.getId() == R.id.execute_master_clear_reboot){
            Intent intent = new Intent(Intent.ACTION_FACTORY_RESET);
            intent.setPackage("android");
            intent.addFlags(Intent.FLAG_RECEIVER_FOREGROUND);
            intent.putExtra(Intent.EXTRA_REASON, "MasterClearConfirm");
    ...
    // urovo weiyu add on 2020-06-30 end
    ...
    private void establishFinalConfirmationState() {
        ...
        // urovo weiyu add on 2020-06-30 start
        mContentView.findViewById(R.id.execute_master_clear_reboot)
                .setOnClickListener(mFinalClickListener);
        mContentView.findViewById(R.id.execute_master_clear_shutdown)
                .setOnClickListener(mFinalClickListener);
        // urovo weiyu add on 2020-06-30 end
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // urovo weiyu add on 2020-09-03 [s]
        getActivity().registerReceiver(new BatteryReceiver(), new IntentFilter(Intent.ACTION_BATTERY_CHANGED));
        // urovo weiyu add on 2020-09-03 [e]
    }
