...
public class PublicVolumeSettings extends SettingsPreferenceFragment {
    ...
    public void update() {
        ...
        if (mDisk.isAdoptable() && mIsPermittedToAdopt) {
            //addPreference(mFormatPrivate); songtingting remove storage private
        }
    }
    ...
    public boolean onPreferenceTreeClick(Preference pref) {
        if (pref == mMount) {
            ...
            //StorageWizardFormatConfirm.showPrivate(getActivity(), mDisk.getId()); songtingting remove storage private 20201208
        }
