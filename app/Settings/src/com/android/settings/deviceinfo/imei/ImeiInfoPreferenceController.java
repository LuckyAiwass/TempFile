...
public class ImeiInfoPreferenceController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        for (int simSlotNumber = 1; simSlotNumber < 3;//mTelephonyManager.getPhoneCount() urovo modify by huangruohui on 20200907
                simSlotNumber++) {
    ...
    //urovo modify by huangruohui on 20200907 begin
    ...
    //urovo modify by huangruohui on 20200907 end
    ...
    private void updatePreference(Preference preference, int simSlot) {
        ...
        if (simSlot == 2) {
            preference.setTitle(getTitleForCdmaPhone(0));
            preference.setSummary(getMeid(0));
        } else {
            // GSM phone
    ...
    private CharSequence getTitleForGsmPhone(int simSlot) {
        return mIsMultiSim ? mContext.getString(R.string.imei_multi_sim_title, simSlot + 1)//imei_multi_sim urovo modify by huangruohui on 20200907
