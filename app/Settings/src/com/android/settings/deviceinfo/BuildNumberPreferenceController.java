...
public class BuildNumberPreferenceController extends BasePreferenceController implements
    ...
    public CharSequence getSummary() {
        /*return SystemProperties.get("ro.build.swversion",mContext.getString(R.string.device_info_default));*/
		//BidiFormatter.getInstance().unicodeWrap(Build.DISPLAY); songtingting modify build version 20201012
        return BidiFormatter.getInstance().unicodeWrap(Build.VENDOR_ID);
    }
