...
public class AccessibilitySettings extends SettingsPreferenceFragment implements
    ...
    private SwitchPreference mGloveModePreference;//begin add by urovo huangruohui
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (mSelectLongPressTimeoutPreference == preference) {
            ...
            return true;
        } else if(mGloveModePreference == preference){ //begin add by urovo huangruohui
            setGloveModeEnable((Boolean) newValue);
            Settings.Global.putInt(getContentResolver(), Settings.Global.SETTINGS_GLOVE_MODE_STATE, (Boolean) newValue ? 1 : 0);
            return true;
        }//end add by urovo huangruohui
        return false;
    }
    ...
    private void initializeAllPreferences() {
        ...
        //begin add by urovo huangruohui
        mGloveModePreference = (SwitchPreference) findPreference("toggle_tp_sensitive");
        mGloveModePreference.setChecked(isGloveModeEnable());
        mGloveModePreference.setOnPreferenceChangeListener(this);
        if(!isGloveModeSupported()){
            mCategoryToPrefCategoryMap.get(CATEGORY_INTERACTION_CONTROL).removePreference(mGloveModePreference);
        }
        //end add by urovo huangruohui
    ...
    //begin add by urovo huangruohui
    //public static final String GLOVE_MODE_FILE = "/sys/devices/soc/c178000.i2c/i2c-4/4-0014/gtp_glove_mode";
    public static String GLOVE_MODE_FILE_SQ53 = "/sys/devices/soc/c178000.i2c/i2c-4/4-0014/gtp_glove_mode";
    public static String GLOVE_MODE_FILE_SQ51FW = "/sys/devices/soc/78b7000.i2c/i2c-3/3-005e/gtp_glove_mode";
    public static String GLOVE_MODE_FILE_GaoGe = "/sys/goodix/smartcover/smart_cover";

    public static String getGloveMdeFile() {
        String GLOVE_MODE_FILE = "";
        if (Build.PROJECT.equals("SQ53") || Build.PROJECT.equals("SQ51S") || Build.PROJECT.equals("SQ53Q") || Build.PROJECT.equals("SQ53Z")) {
            GLOVE_MODE_FILE = GLOVE_MODE_FILE_SQ53;
        } else if (Build.PROJECT.equals("SQ38") || Build.PROJECT.equals("SQ45") || Build.PROJECT.equals("SQ53C") || Build.PROJECT.equals("SQ47")) {
            GLOVE_MODE_FILE = GLOVE_MODE_FILE_GaoGe;
        } else if (Build.PROJECT.equals("SQ51FW")) {
            GLOVE_MODE_FILE = GLOVE_MODE_FILE_SQ51FW;
        }
        Log.d("urovo_glove", "getGloveMdeFile() GLOVE_MODE_FILE = " + GLOVE_MODE_FILE);
        return GLOVE_MODE_FILE;
    }

    public static void setGloveModeEnable(boolean enabled) {
        FileOutputStream outputStream = null;
        try {
            outputStream = new FileOutputStream(getGloveMdeFile()/** urovo yuanwei default GLOVE_MODE_FILE*/);
    ...
    public boolean isGloveModeEnable() {
        return Settings.Global.getInt(getContentResolver(), Settings.Global.SETTINGS_GLOVE_MODE_STATE, 0) == 1;
    }

    private boolean isGloveModeSupported(){
        if (getGloveMdeFile().equals("")) return false;
        File f = new File(getGloveMdeFile()/** urovo yuanwei default GLOVE_MODE_FILE*/);
        return f.exists();
    }
    //begin add by urovo huangruohui
}
