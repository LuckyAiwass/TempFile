...
// add by urovo weiyu on Dec. 25th, 2020 [s]
import android.provider.Settings;
import android.content.ContentResolver;
// add by urovo weiyu on Dec. 25th, 2020 [e]
...
public class SearchMenuController implements LifecycleObserver, OnCreateOptionsMenu {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        // add by urovo weiyu on Dec. 25th, 2020 [s]
        ContentResolver mSystemCR = mHost.getContext().getContentResolver();
        String str = Settings.System.getString(mSystemCR, NEED_SEARCH_ICON_IN_ACTION_BAR);
        if("false".equals(str)) {
            return;
        }
        // add by urovo weiyu on Dec. 25th, 2020 [e]
