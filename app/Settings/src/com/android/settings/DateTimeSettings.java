...
public class DateTimeSettings extends DashboardFragment implements
        TimePreferenceController.TimePreferenceHost, DatePreferenceController.DatePreferenceHost, NtpServerPreferenceController.NtpServerPreferenceHost {
    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        ...
        controllers.add(new DatePreferenceController(
                activity, this /* UpdateTimeAndDateCallback */, autoTimePreferenceController));
        controllers.add(new NtpServerPreferenceController(
                activity, this /* UpdateTimeAndDateCallback */, autoTimePreferenceController));
        return controllers;
    }
    ...
    public Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            case NtpServerPreferenceController.DIALOG_NTPSERVER:
                return use(NtpServerPreferenceController.class)
                        .buildNtpServerDialog(getActivity());
            default:
    ...
    @Override
    public void showNtpServerDialog() {
        showDialog(NtpServerPreferenceController.DIALOG_NTPSERVER);
    }
