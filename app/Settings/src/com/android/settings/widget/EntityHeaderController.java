...
public class EntityHeaderController {
    ...
    public View done(Activity activity, boolean rebindActions) {
		...
		// yangkun modify start 2020/12/24
		if ("io.github.wangcheng678.lockscreen".equals(mPackageName)) {
			iconView.setImageDrawable(mAppContext.getDrawable(R.drawable.lock_screen));
			setText(R.id.entity_header_title, mHeader.getResources().getString(R.string.one_key_lock_screen));
		} else {
