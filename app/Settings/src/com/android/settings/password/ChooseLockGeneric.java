    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private void maybeEnableEncryption(int quality, boolean disabled) {
            ...
            if (UserManager.get(getActivity()).isAdminUser()
				...
				//songtingting remove secure start up 20211019
				if(SystemProperties.getBoolean("ro.unc.model_gms",false)){
                	  ...
                	  startLockIntent(unlockMethodIntent,false);
                }//[e]
            } else {
                if (mForChangeCredRequiredForBoot) {
		...
		//songtingting remove secure start up 20211019
        private void startLockIntent(Intent mUnlockMethodIntent,boolean mPasswordRequired) {
