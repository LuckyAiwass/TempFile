...
public class BluetoothSwitchPreferenceController
    ...
    public BluetoothSwitchPreferenceController(Context context, RestrictionUtils restrictionUtils,
        ...
        // urovo weiyu add on 2020-07-01 start
        if(android.os.SystemProperties.getInt("persist.sys.allow.bluetooth", 0) > 0){
            switchController.setEnabled(false);
        }
        // urovo weiyu add on 2020-07-01 end
    }
