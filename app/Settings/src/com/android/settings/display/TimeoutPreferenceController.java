...
public class TimeoutPreferenceController extends AbstractPreferenceController implements
	...
	//urovo add begin by lq 2020.07.24
	long timeoutValue = (currentTimeout == Integer.MAX_VALUE) ? 0 : currentTimeout;
	...
	//urovo add end by lq
        ...
        updateTimeoutPreferenceDescription(timeoutListPreference, Long.parseLong(timeoutListPreference.getValue()));//songtingting add never
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
	    ...
	    //modify by urovo lq begin
	    int timeoutValue = ( 0 == value) ? Integer.MAX_VALUE : value;
            Settings.System.putInt(mContext.getContentResolver(), SCREEN_OFF_TIMEOUT, timeoutValue/*value*/);
